...
public class NxCinemaCtrl {
    ...
    public static final int CMD_TCON_PIXEL_CORRECTION		= 0x0021;
    public static final int CMD_TCON_PIXEL_CORRECTION_EXTRACT= 0x0022;
    ...
    //
    //  BURST
    public static final int CINEMA_CMD_BURST_START      	= 0xFFFF;
    public static final int CINEMA_CMD_BURST_STOP         	= 0xFFFE;
