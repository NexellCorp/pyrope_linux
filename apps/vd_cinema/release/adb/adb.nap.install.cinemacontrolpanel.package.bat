...
@.\bin\adb.exe -s %NX_DEVICE% push .\image\libnxcinema.so /system/lib/
@.\bin\adb.exe -s %NX_DEVICE% push .\image\nap_server /system/bin/
@.\bin\adb.exe -s %NX_DEVICE% install -r .\image\CinemaControlPanel.apk
