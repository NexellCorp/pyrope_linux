...
@.\bin\adb.exe -s %NX_DEVICE% shell rm /storage/sdcard0/SAMSUNG/TCON_USB/*.txt
@.\bin\adb.exe -s %NX_DEVICE% shell rm /storage/sdcard0/SAMSUNG/TCON_USB/LUT/*.txt
@.\bin\adb.exe -s %NX_DEVICE% shell rm /storage/sdcard0/SAMSUNG/TCON_BEHAVIOR/*.txt
@.\bin\adb.exe -s %NX_DEVICE% shell sync
@pause
