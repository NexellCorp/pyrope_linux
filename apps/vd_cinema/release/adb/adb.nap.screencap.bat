...
@.\bin\adb.exe -s %NX_DEVICE% shell screencap -p /system/bin/capture.png
@.\bin\adb.exe -s %NX_DEVICE% pull /system/bin/capture.png .\result\capture.png
@.\bin\adb.exe -s %NX_DEVICE% shell rm /system/bin/capture.png
@pause
