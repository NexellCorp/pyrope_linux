...
old = Dir.glob( [ 'ca.*', 'intermediate.*', 'leaf.*', 'dc-certificate-chain' ] )
old.each do |file|
  File.delete( file )
end
...
ca_subject = '/OU=CA.SAMSUNG.CO.KR/O=CA.SAMSUNG.CO.KR/CN=.SERVERS.PRODUCTS.CA.SAMSUNG.CO.KR/dnQualifier=' + ca_dnq
...
# Note the absence of role indicators in CA's CN (See SMPTE 430-2-2006 Annex A, CommonName Role Descriptions)
inter_subject = "/OU=CA.SAMSUNG.CO.KR/O=CA.SAMSUNG.CO.KR/CN=.DISPLAY.SERVERS.PRODUCTS.CA.SAMSUNG.CO.KR/dnQualifier=" + inter_dnq
...
leaf_subject = "/OU=CA.SAMSUNG.CO.KR/O=CA.SAMSUNG.CO.KR/CN=PR SM SAP.DISPLAY.SERVERS.PRODUCTS.CA.SAMSUNG.CO.KR/dnQualifier=" + leaf_dnq
