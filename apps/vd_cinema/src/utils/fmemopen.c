...
//
//  Modify by doriya at 181101
//  -.  Remove warning message
//      : warning: comparison between signed and unsigned integer expressions [-Wsign-compare]  : if (size > available) {
//      : warning: comparison between signed and unsigned integer expressions [-Wsign-compare]  : if (size > available) {
//      : warning: unused parameter 'mode' [-Wunused-parameter]                                 : FILE *fmemopen(void *buf, size_t size, const char *mode) {
//
