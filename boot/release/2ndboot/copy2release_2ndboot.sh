...
cp ../../temporary/2ndboot/"$SEC4418_NAME"_SPI.bin   ./"$DST4418_NAME2"_spi.bin
cp ../../temporary/2ndboot/"$SEC4418_NAME"_SPI.bin   ./"$DST4418_NAME3"_spi.bin
