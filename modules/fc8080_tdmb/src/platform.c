...
void platform_hw_setting(void)
{
  ...
  /* pwr */
  //nxp_soc_gpio_set_io_dir(CFG_GPIO_TDMB_POWER, 1);      //output mode
  //nxp_soc_gpio_set_io_pull_enb(CFG_GPIO_TDMB_POWER, 0); //pull disable
...
void platform_hw_init(u32 power_pin, u32 reset_pin)
{
   ...
   //nxp_soc_gpio_set_out_value(CFG_GPIO_TDMB_POWER, CTRUE);
   ms_wait(1);
