...
#include "../include/fci_ringbuffer.h"
	...
	, size_t idx, size_t *pktlen)
{
	...
	while ((fci_ringbuffer_avail(rbuf) - consumed)
		...
		idx =
			(idx + curpktlen + FCI_RINGBUFFER_PKTHDRSIZE)
			% rbuf->size;
	}
